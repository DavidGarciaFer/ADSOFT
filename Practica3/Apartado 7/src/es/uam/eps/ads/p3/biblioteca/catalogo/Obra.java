...
public abstract class Obra {
	...
	/**
	 * Devuelve los ejemplares disponibles de una obra
	 * @return Una lista inmutable de ejemplares
	 */
	...
	/**
	 * Metodo abstracto que realizara las acciones necesarias
	 * para que una obra sea prestada.
	 */
	...
	/**
	 * Compara dos obras, son iguales si tienen mismo
	 * titulo y autor.
	 */
	
	@Override
	public boolean equals(Object o){
		if (o instanceof Obra == false){
			return false;
		}
		if(this.titulo == ((Obra) o).getTitulo() && this.autor == ((Obra) o).getAutor()){
			return true;
		}
		return false;
	}
